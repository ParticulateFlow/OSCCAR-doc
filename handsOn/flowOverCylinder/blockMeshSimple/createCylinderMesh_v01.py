...
radiusCylinder.append(0.5*W*math.sqrt(2.0))
...
CYL_LEVEL_X1 = xCoords.index(C-0.5*W)
CYL_LEVEL_X2 = xCoords.index(C+0.5*W)
CYL_LEVEL_Y1 = yCoords.index(-0.5*W)
CYL_LEVEL_Y2 = yCoords.index(0.5*W)
